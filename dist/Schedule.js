...
var Schedule = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    position: absolute;\n    border: 1px solid rgb(58, 64, 66);\n    border-radius: 5px;\n    height: 20vh;\n    background-color: #294a66;\n    left: ", "vw;\n    width: ", "vw;\n    word-wrap: break-word;\n    text-align: center;\n"])), function (props) {
  return props.left;
}, function (props) {
  return props.width;
});
exports.Schedule = Schedule;
var Station = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    height: 20vh;\n    width: 8vw;\n    background-color: #3a4042;\n    border-bottom: 1px solid rgb(41, 74, 102);\n    border-right: 1px solid rgb(41, 74, 102);\n"])));
var SchedulesContainer = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n    position: relative;\n    display: flex;\n    flex-direction: row;\n    align-items: center;\n"])));
var StationRow = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n    display: flex;\n    flex-direction: row;\n    align-items: center;\n    color: #8ecccc;\n"])));
...
var EpgTimetable = function EpgTimetable(_ref) {
  ...
  var stationsIterable = stationsSchedules.map(function (item, index) {
    return /*#__PURE__*/_react.default.createElement(StationRow, {
      key: index
    }, /*#__PURE__*/_react.default.createElement(Station, null, /*#__PURE__*/_react.default.createElement("h3", null, item.title)), /*#__PURE__*/_react.default.createElement(SchedulesContainer, null, item.schedules.map(function (schedule, scheduleIndex) {
      return /*#__PURE__*/_react.default.createElement(Schedule, {
        left: getLeftVw(new Date(schedule.start)),
        width: getWidthVw(new Date(schedule.start), new Date(schedule.end)),
        key: scheduleIndex
      }, schedule.title, " ", /*#__PURE__*/_react.default.createElement("span", null), " ", /*#__PURE__*/_react.default.createElement("br", null), format24Hour(new Date(schedule.start)), " -", format24Hour(new Date(schedule.end)));
    })));
  });
  return /*#__PURE__*/_react.default.createElement("div", null, stationsIterable);
};
